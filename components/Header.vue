<template>
  <header class="bg-gray-150 dark:bg-gray-900 shadow-md">
    <div class="container mx-auto px-6 md:px-10 py-4 flex justify-between items-center max-w-5xl">
      <!-- Logo -->
      <div class="text-2xl font-bold text-gray-900 dark:text-white">
        <NuxtLink to="/" class="flex items-center space-x-2">
          <!-- Image Link -->
          <img src="../assets/Clarr.jpeg" alt="Clarionconcept Logo" class="w-72 h-24" />
        </NuxtLink>
      </div>
      ...
      <div class="flex items-center space-x-4">
        ...
        <!-- CTA Button -->
        <NuxtLink to="/get-started" class="hidden md:inline-block bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
          Get Started
        </NuxtLink>
      </div>
